          ...
          <div className={styles.cardInner}>
            ...
            <div className={styles.illustrationCol}>
              <div className={styles.illustrationWrapper}>
                <div className={styles.fieldGroup}>
                  <label className={styles.labelLokasi}>Lokasi yang ingin dipilih:</label>
                ...
                <p className={styles.illustrationText}>
                  {formData.location
                    ? `Lokasi terpilih: ${formData.location}`
                    : 'Pilih lokasi di form kiri, peta akan terupdate otomatis.'}
                </p>
              </div>
            </div>
